...
var App = {
  ...
  setPort: function(port_no) {
    settings.port = port_no;
  },

  // Sets the server API prefix.
  ...
  start: function() {
    ...
    console.log('\n' + postTime() + 'Server prefix: ' + settings.prefix);

    // Listen.
    server.listen(settings.port);
    console.log(postTime() + 'Server running on port: ' + settings.port + '.\n');
  }
